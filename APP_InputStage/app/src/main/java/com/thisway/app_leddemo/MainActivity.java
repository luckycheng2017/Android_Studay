...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View myEditText = (View) findViewById(R.id.myEditText);

        myEditText.setOnKeyListener(new View.OnKeyListener() {
            @Override
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                Log.d(TAG, "OnKeyListener.onKey "+keyCode+" "+getKeyStatus(event));
                return false;
            }
        });
...
*/
    ...
    public boolean onKeyDown(int keyCode, KeyEvent keyEvent) {
        Log.d(TAG, "Activity onKeyDown "+keyCode+" "+getKeyStatus(keyEvent));
        return super.onKeyDown(keyCode, keyEvent);
    }

    @Override
    public boolean onKeyUp(int keyCode, KeyEvent keyEvent) {
        Log.d(TAG, "Activity onKeyUp "+keyCode+" "+getKeyStatus(keyEvent));
